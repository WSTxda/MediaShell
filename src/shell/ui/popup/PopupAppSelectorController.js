...
export default class PopupAppSelectorController {
  constructor(popupContent) {
    ...
    this.appSelectorButton = new PopupAppSelectorButton(popupContent, () =>
      this.appSelectorList.toggle(),
    );
    this.appSelectorList = new PopupAppSelectorList(
      popupContent,
      this.appSelectorButton,
    );
  }
