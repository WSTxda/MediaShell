...
export default class AboutDialogController {
    ...
    presentAboutDialog() {
        ...
        const aboutDialog = new Adw.AboutDialog({
            ...
            comments: _(
                "MediaShell integrates configurable MPRIS media controls into the GNOME Shell top bar, with an App selector, Track Information, Playback Controls, Volume Control, Album Art, Playback Progress, Mouse Actions, and Keyboard Shortcuts.",
            ),
            issue_url: ISSUE_URL,
