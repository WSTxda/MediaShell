...
export function initializePreferencesTranslations(gettext, ngettext) {
  if (typeof gettext !== "function")
    throw new TypeError("Preferences gettext must be a function");
  if (typeof ngettext !== "function")
    throw new TypeError("Preferences ngettext must be a function");
...
export function gettext(message) {
  if (!extensionGettext)
    throw new Error("Preferences translations were used before initialization");
  return extensionGettext(message);
}

export function ngettext(singular, plural, count) {
  if (!extensionNgettext)
    throw new Error("Preferences translations were used before initialization");
